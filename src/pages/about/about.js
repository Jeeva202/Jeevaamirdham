...
export default function About() {
    return (
        <div >
            ...
            <div style={{ fontSize: "2rem", fontWeight: "bold", textAlign: "left", paddingTop: "6rem", paddingBottom: "2rem" }}>Our Story</div>
            <div style={{ display: "flex", gap:"2rem" }}>
                <div style={{ flex: 1, color: "#444", lineHeight: "30px" }}>
            ...
            <div style={{ display: "flex", gap:"2rem" }}>
                <div style={{ flex: 1, color: "#444", lineHeight: "30px", marginTop:"2rem"}}>
